...
def mlio_settings(request):
	...
	'like': settings.RENAME_LIKE_DISLIKE[0], \
	'dislike': settings.RENAME_LIKE_DISLIKE[1], \
	...
	'year': year, \
	'stardate': stardate, \
	'top_likes': getTopLikes(settings.TOP_LIKES), \
	'top_dislikes': getTopDislikes(settings.TOP_DISLIKES), \
